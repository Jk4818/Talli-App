...
export const MOCK_DATA: SessionState = {
  ...
  items: [
    // Receipt 1 Items
    { id: 'i_1', receiptId: 'r_1', name: 'Steak Frites', cost: 2500, discounts: [], assignees: ['p_1', 'p_3'], splitMode: 'equal', percentageAssignments: {}, exactAssignments: {}, confidence: 98, category: 'Food', subCategory: 'Main' },
    ...
    { id: 'i_5', receiptId: 'r_1', name: 'Sparkling Water', cost: 400, discounts: [], assignees: ['p_1', 'p_3'], splitMode: 'equal', percentageAssignments: {}, exactAssignments: {}, confidence: 96, category: 'Drink', subCategory: 'Soft Drink' },
